...
app.post("/chat", async (req, res) => {
  try {
    ...
    // Function to handle varied responses, based on previous conversations or inputs
    ...
    async function runChat(userInput, chatHistory) {
      ...
      if (lowerUserInput.includes("wtf") || lowerUserInput.includes("fuck")) {
        ...
        // Look for the name in the history
    ...
    // Update session history with user input and AI response
